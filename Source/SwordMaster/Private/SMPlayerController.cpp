...
{
	static ConstructorHelpers::FClassFinder<USMHUDWidget> UI_HUD_C(TEXT("WidgetBlueprint'/Game/MyAssets/UI/UI_HUD.UI_HUD_C'"));
	if (UI_HUD_C.Succeeded())
	{
		HUDWidgetClass = UI_HUD_C.Class;
	}

	static ConstructorHelpers::FClassFinder<USMGameplayWidget> UI_MENU_C(TEXT("/Game/MyAssets/UI/UI_Menu.UI_Menu_C"));
	if (UI_MENU_C.Succeeded())
	{
		MenuWidgetClass = UI_MENU_C.Class;
	}

	static ConstructorHelpers::FClassFinder<USMGameplayResultWidget> UI_RESULT_C(TEXT("/Game/MyAssets/UI/UI_Result.UI_Result_C"));
